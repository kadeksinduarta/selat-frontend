  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.token && res.user) {
        ...
        setMessage("Registrasi berhasil! Mengalihkan ke halaman profile...");
        ...
        setMessage(res.message || "Terjadi kesalahan saat registrasi");
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                className={`block w-full pl-10 pr-10 py-3 border ${errors.password_confirmation ? "border-red-500" : "border-gray-300"
                  } rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 transition`}
