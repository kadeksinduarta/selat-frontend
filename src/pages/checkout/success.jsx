            ...
            <div className="min-h-screen bg-gray-50 flex items-center justify-center py-20 px-4">
                <div className="max-w-xl w-full bg-white rounded-2xl shadow-xl overflow-hidden">
                    <div className="bg-green-600 p-8 text-center">
                        ...
                        <h1 className="text-3xl font-bold text-white mb-2">Checkout Berhasil!</h1>
                    ...
                    <div className="p-8">
                        <div className="bg-yellow-50 border border-yellow-100 rounded-xl p-4 mb-8 flex gap-3">
                            ...
                            <div className="text-sm text-yellow-800">
                                ...
                                <p>Silakan lakukan pembayaran melalui transfer manual ke rekening desa. Hubungi admin melalui WhatsApp untuk konfirmasi dan instruksi pembayaran.</p>
                            </div>
                        </div>
