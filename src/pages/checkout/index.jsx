...
import { getCart, getCartTotal, clearCart } from "@/pages/utils/cart";
import { userGet, userPost, apiGet } from "@/pages/utils/api";
import { MapPin, User, Phone, CreditCard, ShieldCheck, Loader2 } from "lucide-react";
...
export default function CheckoutPage() {
    ...
    const checkAuthAndLoadData = async () => {
        try {
            ...
            if (!defaultAddress) {
                alert("Mohon lengkapi alamat pengiriman di profil Anda sebelum checkout.");
                ...
                <div className="max-w-4xl mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="md:col-span-2 space-y-6">
                            ...
                            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 flex gap-3 text-blue-800">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm mt-1">
                                        Produk ini menggunakan sistem pemesanan awal. Silakan tentukan tanggal kapan Anda membutuhkan produk ini (pengambilan/pengiriman).
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <p className="text-xs text-gray-500">
                                        *Pastikan tanggal yang dipilih memungkinkan bagi kami untuk menyiapkan pesanan Anda.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                                ...
                                {address ? (
                                    <div className="text-gray-600 text-sm leading-relaxed">
                                        ...
                                        <p>{address.district}, {address.village} {address.postal_code}</p>
                                    </div>
                                ) : (
                            ...
                            {/* Order Items */}
                            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                                <h2 className="text-lg font-bold text-gray-800 mb-4">Rincian Barang</h2>
                                    ...
                                    {cartItems.map((item) => (
                                        <div key={item.id} className="flex gap-4 items-center">
                                            <div className="w-16 h-16 bg-gray-100 rounded-md overflow-hidden flex-shrink-0">
                                                {item.image ? (
                                                    <img
                                                        src={item.image?.startsWith('http') ? item.image : `${process.env.NEXT_PUBLIC_API_URL.replace('/api', '')}/storage/${item.image}`}
                                                        alt={item.name}
                        ...
                        <div className="md:col-span-1">
                            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 sticky top-24">
                                <h2 className="text-lg font-bold text-gray-800 mb-6">Ringkasan Pembayaran</h2>
                                ...
                                <div className="bg-blue-50 p-4 rounded-lg mb-6">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p className="font-bold text-blue-800 text-sm">Metode Pembayaran</p>
                                            <p className="text-sm text-blue-600 mt-1">Transfer Bank (Manual)</p>
                                            <p className="text-xs text-blue-500 mt-2">Silakan transfer ke rekening desa setelah membuat pesanan.</p>
                                        </div>
                                    </div>
                                </div>
