...
const AddressFormModal = ({ isOpen, onClose, initialData, onSuccess, token }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setMessage(initialData ? "Alamat berhasil diupdate" : "Alamat berhasil ditambahkan");
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    {message && (
                        <div className={`p-4 rounded-lg flex items-center gap-3 ${messageType === "success"
...
export default function AddressesPage() {
    ...
    const loadAddresses = async () => {
        try {
            ...
            const sortedData = Array.isArray(data) ? data.sort((a, b) => (b.is_default ? 1 : 0) - (a.is_default ? 1 : 0)) : [];
                    ...
                    {addresses.length === 0 ? (
                        ...
                        <div className="space-y-4">
                            {addresses.map((address) => (
                                <div
                                    key={address.id}
                                    className={`bg-white rounded-xl shadow-sm p-6 relative border ${address.is_default ? "border-green-500 ring-1 ring-green-500" : "border-gray-200"}`}
                                >
                                    {address.is_default && (
